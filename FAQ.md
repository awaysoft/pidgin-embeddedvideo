...
Did you check if the site is currently supported? If it is, we could have a bug in our implementation. Please tell us about it by opening [a new issue](http://code.google.com/p/pidgin-embeddedvideo/issues/list).
...
Go to the "[Configure Plugin](http://code.google.com/p/pidgin-embeddedvideo/wiki/Screenshots#Configuration)" menu and deselect the "Show every video instantly" option. Thereby, videos will be hidden by default. You can watch them by clicking on the toggle button (the little arrow).

### I want support for a new video site. What can I do? ###

If you want a new video site which is not supported, please feel free to ask for it by opening [a new issue](http://code.google.com/p/pidgin-embeddedvideo/issues/list).